...
function DatosExtra(){
    return (
        ...
        <section className=" min-w-full m-2 col lg:justify-between pr-24 pl-2 mb-10 lg:flex ">
            <section className="bg-blue-300 text-white w-full my-8 lg:my-0 lg:w-1/5 rounded-lg overflow-hidden shadow-lg">
            ...
            <section className="bg-green-400 text-white w-full my-8 lg:my-0 lg:w-1/5 rounded-lg overflow-hidden shadow-xl">
                <section className="w-full ml-2 mt-2 flex justify-between">
            ...
            <section className="bg-yellow-300 text-white w-full my-8 lg:my-0 lg:w-1/5 overflow-hidden rounded-lg shadow-xl">
                <section className="w-full ml-2 mt-2  flex justify-between">
            ...
            <section className="bg-red-600 w-full lg:w-1/5 my-8 lg:my-0 text-white overflow-hidden rounded-lg shadow-xl">
                <section className="w-full ml-2 mt-2 flex justify-between">
